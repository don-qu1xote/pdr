...
UNCOVERED = {
    ...
    'непроверенный путь: участие пишется доменом и проверено contract-набором на '
    'обеих реализациях, но ручки, которая меняет цену, оплату или исход участия, '
    'в этом процессе ещё нет — групповые занятия заложены в модель и не введены '
    '(PDR-SCHED-08, docs/adr/0023-group-lessons-modelled-not-implemented.md)': {
        'scheduling_lesson_participation_set',
    },
