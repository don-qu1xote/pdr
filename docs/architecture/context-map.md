...
* `scheduling_lesson_participant` — кто на нём занимается. Отдельной таблицей,
  потому что участник в домене — вектор: групповые занятия появятся
  (`PDR-SCHED-08`), и переписывать под них схему не придётся;
